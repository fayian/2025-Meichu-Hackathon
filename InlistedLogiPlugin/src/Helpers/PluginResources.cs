namespace Loupedeck.InlistedPlugin.Helpers
{
    using System;
    using System.IO;
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.InlistPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.InlistPlugin.Resources.Resource.txt`.
