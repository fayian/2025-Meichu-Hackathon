...
class TaskManager {
    ...
    handleTaskSubmission() {
        ...
        window.inlistedApp.showNotification('任務已新增', `任務"${task.name}"已成功新增`);
    }
    ...
    toggleTaskComplete(taskId) {
        ...
        if (task) {
            ...
            window.inlistedApp.showNotification('任務狀態更新', `任務"${task.name}"已${status}`);
        }
    }
    ...
    getFilteredTasks() {
        ...
        return filtered.sort((a, b) => {
            ...
            const urgencyA = window.inlistedApp.calculateUrgency(a.deadline, a.priority);
            const urgencyB = window.inlistedApp.calculateUrgency(b.deadline, b.priority);
    ...
    createTaskElement(task) {
        ...
        return `
            <div class="task-item ${priorityColors[task.priority]} ${task.completed ? 'completed' : ''} ${isOverdue ? 'overdue' : ''}">
                <div class="task-header">
                    <div class="task-name">${task.name}</div>
                    <div class="task-actions">
                        <button class="btn btn-secondary complete-btn" data-task-id="${task.id}">
                ...
                <div class="task-meta">
                    <div class="task-meta-item">
                        ...
                        <span>${window.inlistedApp.formatDateTime(deadline)}</span>
                    </div>
                    <div class="task-meta-item">
                    ...
                    <div class="task-meta-item">
                        ...
                        <span>預估: ${window.inlistedApp.formatDuration(task.duration)}</span>
                    </div>
    ...
    syncWithGoogleCalendar() {
        ...
        window.inlistedApp.showNotification('功能開發中', 'Google日曆整合功能正在開發中');
    }
}
